...
import TranslationInfo from '../../../../components/operation_manager_full_dashboard_components/book_details/TranslationInfo';
import EditionsInfo from '../../../../components/operation_manager_full_dashboard_components/book_details/EditionsInfo';
import StoresList from '../../../../components/operation_manager_full_dashboard_components/book_details/StoresList';
import ShopDistributionList from '../../../../components/operation_manager_full_dashboard_components/book_details/ShopDistributionList';
import CostsInfo from '../../../../components/admin_dashboard_components/book_details/CostsInfo';
import DeleteBook from '../../../../components/operation_manager_full_dashboard_components/book_details/DeleteBook';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 md:h-24 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            <Button asChild variant="ghost" className="h-10 md:h-14 px-3 md:px-8 rounded-xl md:rounded-2xl border-2 border-primarycolor/5 hover:bg-primarycolor hover:text-white transition-all font-black uppercase tracking-widest text-[10px] md:text-xs gap-2">
              <Link href={`${dashboardRoot}/production/books`}>
