            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center justify-end">
                        {item.status !== "NOT_IN_PROJECT" && (
                            <Link href={`/operation_manager_full_dashboard/printing/manage/${item.orderId}`}>
                        ...
                        return (
                            <div key={item.id} className="bg-white rounded-2xl border-2 border-primarycolor/5 p-5 space-y-4 hover:shadow-md transition-all">
                                ...
                                <div className="flex items-center gap-2">
                                    {item.status !== "NOT_IN_PROJECT" ? (
                                        <>
                                            <Link href={`/operation_manager_full_dashboard/printing/manage/${item.orderId}`} className="flex-1">
                                                <Button
                                                    variant="outline"
