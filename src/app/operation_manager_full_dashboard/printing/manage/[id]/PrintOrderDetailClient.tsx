    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                router.push("/operation_manager_full_dashboard/printing/manage")
            } else {
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                    <Button variant="ghost" asChild className="p-0 h-auto hover:bg-transparent text-primarycolor/50 font-black uppercase tracking-widest text-[10px]">
                                        <Link href="/operation_manager_full_dashboard/printing/manage" className="flex items-center gap-1">
