            ...
            <div className="mb-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="space-y-2 text-center md:text-left">
                    ...
                    <p className="text-muted-foreground font-bold tracking-tight text-lg">
                        Monitor and manage the lifecycle of your titles from draft to distribution.
                    </p>
                </div>
            ...
            {response.success ? (
                ...
                <div className="p-12 border-2 border-destructive/20 bg-destructive/5 rounded-[2rem] text-center space-y-4">
                    ...
                    <p className="text-muted-foreground font-medium max-w-xs mx-auto">
                        We couldn't synchronize with the production database. Please check your connection.
                    </p>
                </div>
            )}
        </div>
