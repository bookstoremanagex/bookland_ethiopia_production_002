                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuSubButton
                            ...
                            isActive={
                              isMounted &&
                              (activePath ===
                                "/admin_dashboard/production/80-20" ||
                                activePath.startsWith(
                                  "/admin_dashboard/production/80-20/",
                                ))
                            }
                          ...
                          >
                            <Link href="/admin_dashboard/production/80-20">
                              <TrendingUp
                                className={cn(
                                  "w-4 h-4",
                                  isMounted &&
                    ...
                    <CollapsibleContent>
                      <SidebarMenuSub>
                        ...
                        <SidebarMenuSubItem>
                          ...
                          >
                            <Link href="/admin_dashboard/printing/info">
                              <BarChart3
                                className={cn(
                                  "w-4 h-4",
                                  isMounted &&
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuSubButton
                            ...
                            isActive={
                              isMounted &&
                              (activePath ===
                                "/admin_dashboard/finance/printing" ||
                                activePath.startsWith(
                                  "/admin_dashboard/finance/printing/",
                                ))
                            }
                          ...
                          >
                            <Link href="/admin_dashboard/finance/printing">
                              <Printer
                                className={cn(
                                  "w-4 h-4",
                                  isMounted &&
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuSubButton
                            ...
                            isActive={
                              isMounted &&
                              (activePath ===
                                "/admin_dashboard/finance/round-info" ||
                                activePath.startsWith(
                                  "/admin_dashboard/finance/round-info/",
                                ))
                            }
                          ...
                          >
                            <Link href="/admin_dashboard/finance/round-info">
                              <Repeat
                                className={cn(
                                  "w-4 h-4",
                                  isMounted &&
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuSubButton
                            ...
                            isActive={
                              isMounted &&
                              (activePath ===
                                "/admin_dashboard/finance/payments-due" ||
                                activePath.startsWith(
                                  "/admin_dashboard/finance/payments-due/",
                                ))
                            }
                          ...
                          >
                            <Link href="/admin_dashboard/finance/payments-due">
                              <BadgeDollarSign
                                className={cn(
                                  "w-4 h-4",
                                  isMounted &&
