                  ...
                  >
                    ...
                    <td className="p-6 text-right">
                      <Button
                        asChild
                        variant="ghost"
                        className="h-12 px-6 rounded-xl hover:bg-primarycolor hover:text-white transition-all font-black uppercase tracking-widest text-[10px] gap-2"
                      >
                        <Link
                          href={`${dashboardRoot}/books/editions/${assignment.editionId}`}
                        >
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <Button
                    ...
                    size="icon"
                    variant="ghost"
                    className="size-10 rounded-xl bg-primarycolor/5"
                  >
                    <Link
                      href={`${dashboardRoot}/books/editions/${assignment.editionId}`}
                    >
